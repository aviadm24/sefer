...
class TaharaImage(models.Model):
    ...
    logo_image = models.ImageField(null=True, blank=True, upload_to='logo')
    ...
    second_pesak = models.CharField(max_length=250, null=True, blank=True, choices=ANSWERS, verbose_name="פסק")
